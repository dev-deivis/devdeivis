...
const LINKS = [
  {
    id: "videos",
    label: "mis_reels()",
    comment: "// videos & reels",
    icon: (
      <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
        <polygon points="5 3 19 12 5 21 5 3" />
      </svg>
    ),
    href: "https://www.instagram.com/_devdeivis/reels/",
    color: "#64ffda",
  },
  {
    id: "portfolio",
    label: "portafolio()",
    comment: "// proyectos & código",
    icon: (
      <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    href: "https://github.com/dev-deivis",
    color: "#ffcb6b",
  },
  {
    id: "guias",
    label: "guias_tutoriales()",
    comment: "// aprende conmigo",
    icon: (
      <svg width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
    ...
    href: "https://www.instagram.com/_devdeivis/",
    color: "#89ddff",
  },
  {
    id: "contact",
...
function useTyping(text, speed = 60, delay = 0) {
...
function TypingText({ text, speed = 55, delay = 0, className = "", color = "#64ffda" }) {
  ...
  return (
    <a
      ...
      style={{
        ...
        padding: "14px 20px",
        borderRadius: "8px",
        border: `1px solid ${hovered ? link.color : "rgba(255,255,255,0.07)"}`,
        background: hovered
          ? `${link.color}12`
        ...
        transform: visible
          ...
          : "translateX(-20px)",
        opacity: visible ? 1 : 0,
        boxShadow: hovered ? `0 0 24px ${link.color}22` : "none",
        cursor: "pointer",
      }}
    >
      {/* Line number */}
      <span style={{ color: "rgba(255,255,255,0.15)", fontSize: "11px", fontFamily: "JetBrains Mono, monospace", minWidth: "20px", userSelect: "none" }}>
        {String(index + 1).padStart(2, "0")}
      </span>

      {/* Comment */}
      <span style={{ color: "rgba(255,255,255,0.25)", fontSize: "12px", fontFamily: "JetBrains Mono, monospace", minWidth: "160px", display: "none" }} className="comment">
        {link.comment}
      </span>
      ...
      <span
        style={{
          ...
          fontSize: "14px",
          fontWeight: 500,
          color: hovered ? link.color : "#e2e8f0",
          flex: 1,
      ...
      {/* Arrow */}
      <span style={{ color: hovered ? link.color : "rgba(255,255,255,0.2)", transition: "all 0.2s", transform: hovered ? "translateX(4px)" : "none" }}>
        ...
        <div style={{ width: "100%", maxWidth: "480px" }}>
          ...
          <div
            style={{
              ...
              borderBottom: "none",
              animation: loaded ? "fadeDown 0.5s ease forwards" : "none",
              opacity: 0,
            }}
          >
          ...
          <div
            style={{
              ...
              animation: loaded ? "fadeDown 0.5s ease 0.1s forwards" : "none",
              opacity: 0,
            }}
          >
              ...
              {[
                ...
                <a
                  ...
                  onMouseEnter={e => {
                    ...
                    e.currentTarget.style.filter = `drop-shadow(0 0 10px ${s.color})`;
                  }}
                  onMouseLeave={e => {
                    e.currentTarget.style.color = s.color;
                    e.currentTarget.style.transform = "none";
                    e.currentTarget.style.filter = `drop-shadow(0 0 5px ${s.color}88)`;
                  }}
                >
                  {s.icon}
                </a>
